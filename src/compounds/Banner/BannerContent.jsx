  ...
  return (
    <div className="absolute top-[20%] left-0 w-full z-20">
      <div className="container mx-auto px-4">
        ...
        />
        <h3 className="font-extrabold text-3xl sm:text-4xl md:text-5xl lg:text-7xl w-full md:w-[686px] font-open my-4 md:my-8 text-center lg:text-left">
          We Are Digital <span className="text-btnColor">Marketing</span> Agency
        </h3>
        <p className="font-paprika text-base sm:text-lg md:text-xl w-full md:w-[571px] text-[#6C7D93] mb-4 md:mb-8 text-center lg:text-left">
